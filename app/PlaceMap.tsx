...
export default function PlaceMap({
  ...
  labels: { map: string; route: string; badge: string; close: string; site: string; walk: string; mapFailed: string; mapFailedHint: string; house: string; departReset: string };
