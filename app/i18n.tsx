...
export type Dict = {
  ...
  scicliAlt: string;
  placesTitle: string;
  salvaPage: { title: string; intro: string; historyTitle: string; historyText: string; treeTitle: string; treeNote: string; treeAdd: string; treeExample: string };
...
const FR: Dict = {
  ...
  salvaPage: { title: 'La famille', intro: 'Photos, souvenirs et histoire de la famille, au fil des années.', historyTitle: 'Histoire de la famille', historyText: "De génération en génération, cette maison de Cava d’Aliga rassemble la famille. On écrira bientôt son histoire ici — les origines, les étés partagés et les visages qui l’ont fait vivre.", treeTitle: 'Arbre généalogique', treeNote: 'Bientôt : un arbre participatif où chacun pourra ajouter sa branche.', treeAdd: '+ Ajouter', treeExample: 'Structure d’exemple — dites-nous les vrais liens et on complète.' },
