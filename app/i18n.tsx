...
const FR: Dict = {
  ...
  quizPage: {
    ...
    questions: [
      ...
      { q: 'Qu’y a-t-il dans les pâtes aux sardines ?', choix: ['Fenouil sauvage, raisins secs, pignons et safran', 'Crème et lardons', 'Tomate et basilic seulement'], bonne: 0, ancre: 'specialites', niveau: 'facile' },
      { q: 'Qu’est-ce qui caractérise la caponata ?', choix: ['L’aigre-doux : vinaigre et sucre', 'Le piment fort', 'La cuisson au feu de bois'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'La frutta martorana est faite de…', choix: ['Pâte d’amande', 'Pâte à sucre', 'Chocolat de Modica'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'La cassata tiendrait son nom de qas‘ah, qui désigne…', choix: ['Le bol dans lequel on la moulait', 'La ricotta', 'Une fête religieuse'], bonne: 0, ancre: 'specialites', niveau: 'difficile' },
    ],
  },
  askMag: {
  ...
  arrivee: {
    ...
    operation: [
      ...
      { icon: 'drop', title: 'Eau', items: ['Pour ouvrir l’eau : la vanne est dans la buanderie, à l’arrière, sur le mur entre le lave-linge et l’évier. La clé de la buanderie est juste là, dans le petit meuble à tiroirs du buffet du salon.'] },
...
const IT: Dict = {
  ...
  quizPage: {
    ...
    questions: [
      ...
      { q: 'Che cosa c’è nella pasta con le sarde?', choix: ['Finocchietto selvatico, uvetta, pinoli e zafferano', 'Panna e pancetta', 'Solo pomodoro e basilico'], bonne: 0, ancre: 'specialites', niveau: 'facile' },
      { q: 'Che cosa caratterizza la caponata?', choix: ['L’agrodolce: aceto e zucchero', 'Il peperoncino forte', 'La cottura a legna'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'La frutta martorana è fatta di…', choix: ['Pasta di mandorle', 'Pasta di zucchero', 'Cioccolato di Modica'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'La cassata prenderebbe il nome da qas‘ah, che indica…', choix: ['La scodella in cui la si modellava', 'La ricotta', 'Una festa religiosa'], bonne: 0, ancre: 'specialites', niveau: 'difficile' },
    ],
  },
  askMag: {
  ...
  arrivee: {
    ...
    operation: [
      ...
      { icon: 'drop', title: 'Acqua', items: ['Per aprire l’acqua: la valvola è in lavanderia, sul retro, sul muro tra la lavatrice e il lavello. La chiave della lavanderia è lì vicino, nel mobiletto a cassetti della credenza del salotto.'] },
...
const EN: Dict = {
  ...
  quizPage: {
    ...
    questions: [
      ...
      { q: 'Marsala comes from “marsa”. What does it mean?', choix: ['The harbour', 'The mountain', 'The bridge'], bonne: 0, ancre: 'arabe', niveau: 'moyen' },
      ...
      { q: 'What goes into pasta with sardines?', choix: ['Wild fennel, raisins, pine nuts and saffron', 'Cream and bacon', 'Only tomato and basil'], bonne: 0, ancre: 'specialites', niveau: 'facile' },
      { q: 'What defines caponata?', choix: ['Sweet and sour: vinegar and sugar', 'Fierce chilli heat', 'Cooking over a wood fire'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'Frutta martorana is made of…', choix: ['Almond paste', 'Sugar paste', 'Modica chocolate'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'Cassata may be named after qas‘ah, which means…', choix: ['The bowl it was shaped in', 'Ricotta', 'A religious feast'], bonne: 0, ancre: 'specialites', niveau: 'difficile' },
    ],
  },
  askMag: {
  ...
  arrivee: {
    ...
    operation: [
      ...
      { icon: 'drop', title: 'Water', items: ['To turn the water on: the valve is in the laundry room at the back, on the wall between the washing machine and the sink. The laundry-room key is right there, in the little chest of drawers in the living-room sideboard.'] },
