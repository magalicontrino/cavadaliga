...
export type Dict = {
  ...
  scicliAlt: string;
  placesTitle: string;
  salvaPage: { title: string; intro: string; historyTitle: string; historyText: string; treeTitle: string; treeNote: string; treeAdd: string; treeAddSubject: string; treeExample: string };
...
const FR: Dict = {
  nav: ['Accueil', 'Préparer le voyage', 'Informations pratiques', 'Services locaux', 'La région', 'La famille', 'Calendrier', 'Contact'],
  region: 'Sicile',
  ...
  salvaPage: { title: 'La famille', intro: 'Photos, souvenirs et histoire de la famille, au fil des années.', historyTitle: 'Histoire de la famille', historyText: "De génération en génération, cette maison de Cava d’Aliga rassemble la famille. On écrira bientôt son histoire ici — les origines, les étés partagés et les visages qui l’ont fait vivre.", treeTitle: 'Arbre généalogique', treeNote: 'Bientôt : un arbre participatif où chacun pourra ajouter sa branche.', treeAdd: '+ Ajouter ma branche', treeAddSubject: 'Arbre généalogique — ma branche', treeExample: 'Structure d’exemple — dites-nous les vrais liens et on complète.' },
...
const IT: Dict = {
  nav: ['Home', 'Preparare il viaggio', 'Informazioni pratiche', 'Servizi locali', 'La regione', 'La famiglia', 'Calendario', 'Contatti'],
  region: 'Sicilia',
...
const EN: Dict = {
  nav: ['Home', 'Plan your trip', 'Practical information', 'Local services', 'The region', 'The family', 'Calendar', 'Contact'],
  region: 'Sicily',
