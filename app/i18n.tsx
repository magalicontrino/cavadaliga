...
export type Dict = {
  ...
  stayPage: {
    ...
    legend: { mag: string; close: string; works: string; inlaw: string; family: string; outside: string; tentative: string; free: string };
  };
...
const FR: Dict = {
  ...
  stayPage: { title: 'Le calendrier', intro: 'Les périodes où la maison est occupée, pour se coordonner en famille.', legend: { mag: 'Mag', close: 'Famille proche', inlaw: 'La belle-famille', family: 'Les cousins', outside: 'Hors famille', works: 'En travaux', tentative: 'À confirmer', free: 'Libre' } },
...
const IT: Dict = {
  ...
  stayPage: { title: 'Il calendario', intro: 'I periodi in cui la casa è occupata, per coordinarsi in famiglia.', legend: { mag: 'Mag', close: 'Famiglia stretta', inlaw: 'I parenti acquisiti', family: 'I cugini', outside: 'Fuori famiglia', works: 'Lavori in corso', tentative: 'Da confermare', free: 'Libero' } },
...
const EN: Dict = {
  ...
  stayPage: { title: 'The calendar', intro: 'When the house is occupied, so the family can coordinate.', legend: { mag: 'Mag', close: 'Close family', inlaw: 'In-laws', family: 'Cousins', outside: 'Outside the family', works: 'Works under way', tentative: 'To confirm', free: 'Free' } },
