...
const FR: Dict = {
  ...
  regionHighlights: [
    ...
    ['L’une des plus longues plages de sable de la côte.'],
    ['Exploration des ruines de la Fornace Penna au coucher du soleil.'],
...
const IT: Dict = {
  ...
  regionHighlights: [
    ...
    ['Centro barocco patrimonio mondiale dell’UNESCO.'],
    ['Riserve naturali e sentieri lungo la costa.', 'Bagni tranquilli, lontano dalla folla.'],
    ['Una delle spiagge di sabbia più lunghe della costa.'],
    ['Esplorazione delle rovine della Fornace Penna al tramonto.'],
...
const EN: Dict = {
  ...
  regionHighlights: [
    ...
    ['Baroque centre listed as a UNESCO World Heritage site.'],
    ['Nature reserves and coastal trails.', 'Quiet swims, away from the crowds.'],
    ['One of the longest sandy beaches on the coast.'],
    ['Explore the Fornace Penna ruins at sunset.'],
