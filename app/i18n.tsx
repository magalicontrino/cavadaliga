...
export type Dict = {
  ...
  scicliAlt: string;
  placesTitle: string;
  salvaPage: { title: string; intro: string; historyTitle: string; historyText: string; treeTitle: string; treeNote: string };
