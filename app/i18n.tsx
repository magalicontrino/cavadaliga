...
const EN: Dict = {
  ...
  ], storyOpen: 'This story is written by many hands. A date, a place, a name, an anecdote, a photograph — send them over and they will find their place here. Most useful of all: say who you are talking about, when, and where. That is what lets us hook each piece onto the right spot.', storyOpenCta: 'Add to the story', storyOpenSubject: 'Family history — I have something to add', treeTitle: 'Family tree', treeNote: 'What the family has passed on to us. Blanks remain — they are listed at the bottom, and anyone can fill them in.', treePaternal: 'Paternal grandparents', treeMaternal: 'Maternal grandparents', treeWife1: '1st wife', treeWife2: '2nd wife', treeMarriage1: '1st marriage', treeMarriage2: '2nd marriage', treeGreat: 'Great-grandparents', treeParents: 'The parents', treeChildren: 'The children', treeQuestionsTitle: 'What we are missing', treeQuestionsNote: 'These boxes are empty because nobody has given us the answer yet — not because there is none. You are family and you know? Tell us: that is how the tree grows.', treeAdd: '+ Add my branch', treeAddSubject: 'Family tree — my branch', treeExample: 'People and dates are missing — tell us what you know.' },
