...
export type Dict = {
  ...
  stayPage: {
    ...
    legend: { close: string; family: string; outside: string; tentative: string; free: string };
  };
...
const FR: Dict = {
  ...
  ], storyOpen: 'Cette histoire s’écrit à plusieurs. Une date, un lieu, un nom, une anecdote, une photo — envoyez-les, et ils prendront leur place ici. Le plus utile : dites de qui vous parlez, quand, et où. C’est ce qui permet de raccrocher chaque morceau au bon endroit.', storyOpenCta: 'Ajouter à l’histoire', storyOpenSubject: 'Histoire de la famille — j’ai quelque chose à ajouter', treeTitle: 'Arbre généalogique', treeNote: 'Ce que la famille nous a transmis. Il reste des blancs — ils sont listés en bas, et chacun peut les combler.', treePaternal: 'Grands-parents paternels', treeMaternal: 'Grands-parents maternels', treeWife1: '1re épouse', treeWife2: '2e épouse', treeMarriage1: '1er mariage', treeMarriage2: '2e mariage', treeGreat: 'Arrière-grands-parents', treeGreat2: 'Arrière-arrière-grands-parents', treeGen5: '5 générations en arrière', treeGen6: '6 générations en arrière', treeGen7: '7 générations en arrière', treeGen8: '8 générations en arrière', treeAbout: 'vers', treeBefore: 'avant', treeAfter: 'après', treeWed: 'mariés en', treeWedAbout: 'mariés vers', treeParents: 'Les parents', treeChildren: 'Les enfants', treeQuestionsTitle: 'Ce qu’il nous manque', treeAdd: '+ Ajouter ma branche', treeAddSubject: 'Arbre généalogique — ma branche', treeExample: 'Il manque du monde, et des dates — dites-nous ce que vous savez.', treeOpen: 'Déplier', treeClose: 'Replier', treeOpenAll: 'Tout déplier', treeCloseAll: 'Tout replier', treeKid: 'enfant', treeKids: 'enfants', treeSideFather: 'Côté Contrino', treeSideMother: 'Côté Lux', treeSideUs: 'Nous' },
  stayPage: { title: 'Le calendrier', intro: 'Les périodes où la maison est occupée, pour se coordonner en famille.', legend: { close: 'Famille proche', family: 'La famille', outside: 'Hors famille', tentative: 'À confirmer', free: 'Libre' } },
...
const IT: Dict = {
  ...
  ], storyOpen: 'Questa storia si scrive in tanti. Una data, un luogo, un nome, un aneddoto, una foto — mandateli e troveranno il loro posto qui. La cosa più utile: dite di chi parlate, quando e dove. È ciò che permette di agganciare ogni pezzo al punto giusto.', storyOpenCta: 'Aggiungere alla storia', storyOpenSubject: 'Storia della famiglia — ho qualcosa da aggiungere', treeTitle: 'Albero genealogico', treeNote: 'Quello che la famiglia ci ha trasmesso. Restano dei vuoti — sono elencati in fondo, e ognuno può colmarli.', treePaternal: 'Nonni paterni', treeMaternal: 'Nonni materni', treeWife1: '1ª moglie', treeWife2: '2ª moglie', treeMarriage1: '1º matrimonio', treeMarriage2: '2º matrimonio', treeGreat: 'Bisnonni', treeGreat2: 'Trisnonni', treeGen5: '5 generazioni indietro', treeGen6: '6 generazioni indietro', treeGen7: '7 generazioni indietro', treeGen8: '8 generazioni indietro', treeAbout: 'circa', treeBefore: 'prima del', treeAfter: 'dopo il', treeWed: 'sposati nel', treeWedAbout: 'sposati verso il', treeParents: 'I genitori', treeChildren: 'I figli', treeQuestionsTitle: 'Quello che ci manca', treeAdd: '+ Aggiungi il mio ramo', treeAddSubject: 'Albero genealogico — il mio ramo', treeExample: 'Mancano persone e date — diteci quello che sapete.', treeOpen: 'Apri', treeClose: 'Chiudi', treeOpenAll: 'Apri tutto', treeCloseAll: 'Chiudi tutto', treeKid: 'figlio', treeKids: 'figli', treeSideFather: 'Ramo Contrino', treeSideMother: 'Ramo Lux', treeSideUs: 'Noi' },
  stayPage: { title: 'Il calendario', intro: 'I periodi in cui la casa è occupata, per coordinarsi in famiglia.', legend: { close: 'Famiglia stretta', family: 'La famiglia', outside: 'Fuori famiglia', tentative: 'Da confermare', free: 'Libero' } },
...
const EN: Dict = {
  ...
  ], storyOpen: 'This story is written by many hands. A date, a place, a name, an anecdote, a photograph — send them over and they will find their place here. Most useful of all: say who you are talking about, when, and where. That is what lets us hook each piece onto the right spot.', storyOpenCta: 'Add to the story', storyOpenSubject: 'Family history — I have something to add', treeTitle: 'Family tree', treeNote: 'What the family has passed on to us. Blanks remain — they are listed at the bottom, and anyone can fill them in.', treePaternal: 'Paternal grandparents', treeMaternal: 'Maternal grandparents', treeWife1: '1st wife', treeWife2: '2nd wife', treeMarriage1: '1st marriage', treeMarriage2: '2nd marriage', treeGreat: 'Great-grandparents', treeGreat2: 'Great-great-grandparents', treeGen5: '5 generations back', treeGen6: '6 generations back', treeGen7: '7 generations back', treeGen8: '8 generations back', treeAbout: 'around', treeBefore: 'before', treeAfter: 'after', treeWed: 'married in', treeWedAbout: 'married around', treeParents: 'The parents', treeChildren: 'The children', treeQuestionsTitle: 'What we are missing', treeAdd: '+ Add my branch', treeAddSubject: 'Family tree — my branch', treeExample: 'People and dates are missing — tell us what you know.', treeOpen: 'Expand', treeClose: 'Collapse', treeOpenAll: 'Expand all', treeCloseAll: 'Collapse all', treeKid: 'child', treeKids: 'children', treeSideFather: 'Contrino side', treeSideMother: 'Lux side', treeSideUs: 'Us' },
  stayPage: { title: 'The calendar', intro: 'When the house is occupied, so the family can coordinate.', legend: { close: 'Close family', family: 'The family', outside: 'Outside the family', tentative: 'To confirm', free: 'Free' } },
