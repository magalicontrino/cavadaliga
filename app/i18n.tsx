...
const FR: Dict = {
  ...
  quizPage: {
    ...
    questions: [
      ...
      { q: 'Sur la route de Catane à la maison, le péage…', choix: ['Il n’y en a aucun, ces autoroutes sont gratuites', 'Coûte une vingtaine d’euros', 'Se paie à Modica'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Ensuite la route ne se discute pas : la rocade, l’autoroute vers Syracuse, puis la Siracusa-Gela. Aucun péage nulle part sur ce trajet, à ce jour — ces deux autoroutes-là sont gratuites, contrairement à celle qui longe l’Etna vers Messine. Pour Cava d’Aliga on ne va pas jusqu’à Modica : on sort à Ispica-Pozzallo et on finit par la route de la côte, en passant par Sampieri. Environ 130 km, et près de deux heures plutôt qu’une heure et demie.',
        ],
      },
      {
        icon: '🚗',
...
const IT: Dict = {
  ...
  quizPage: {
    ...
    questions: [
      ...
      { q: 'Sulla strada da Catania a casa, il pedaggio…', choix: ['Non c’è, queste autostrade sono gratuite', 'Costa una ventina di euro', 'Si paga a Modica'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          'Poi la strada è una sola: la tangenziale, l’autostrada per Siracusa, quindi la Siracusa-Gela. Nessun pedaggio da nessuna parte su questo percorso, a oggi — queste due autostrade sono gratuite, a differenza di quella che costeggia l’Etna verso Messina. Per Cava d’Aliga non si arriva fino a Modica: si esce a Ispica-Pozzallo e si finisce sulla litoranea, passando da Sampieri. Circa 130 km, e quasi due ore più che un’ora e mezza.',
        ],
      },
      {
        icon: '🚗',
...
const EN: Dict = {
  ...
  quizPage: {
    ...
    questions: [
      ...
      { q: 'On the road from Catania to the house, the toll…', choix: ['There is none, those motorways are free', 'Costs about twenty euros', 'Is paid at Modica'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          'The road is then straightforward: the ring road, the motorway towards Syracuse, then the Siracusa-Gela. No toll anywhere on this route, as things stand — those two motorways are free, unlike the one running along Etna towards Messina. For Cava d’Aliga you do not go as far as Modica: you leave at Ispica-Pozzallo and finish along the coast road, through Sampieri. About 130 km, and closer to two hours than to an hour and a half.',
        ],
      },
      {
        icon: '🚗',
