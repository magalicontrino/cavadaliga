...
const FR: Dict = {
  ...
  salvaPage: { title: 'La famille', intro: 'Photos, souvenirs et histoire de la famille, au fil des années.', historyTitle: 'Histoire de la famille', storyText: [
    ...
    'Son père Angelo, revenu des camps russes, s’est retrouvé veuf avec un bébé de six mois. Il l’a confié à sa mère Giuseppina — mémé Pipine —, émigrée à Saint-Étienne avec ses enfants, qui l’a élevé comme le neuvième de la fratrie.',
  ...
  ], treeTitle: 'Arbre généalogique', treeNote: 'Ce que la famille nous a transmis. Il reste des blancs — ils sont listés en bas, et chacun peut les combler.', treePaternal: 'Grands-parents paternels', treeMaternal: 'Grands-parents maternels', treeWife1: '1re épouse', treeWife2: '2e épouse', treeMarriage1: '1er mariage', treeMarriage2: '2e mariage', treeGreat: 'Arrière-grands-parents', treeParents: 'Les parents', treeQuestionsTitle: 'Ce qu’il nous manque', treeQuestionsNote: 'Ces cases sont vides parce que personne ne nous a encore donné la réponse — pas parce qu’elles n’existent pas. Vous êtes de la famille et vous savez ? Dites-le-nous : c’est comme ça que l’arbre grandit.', treeAdd: '+ Ajouter ma branche', treeAddSubject: 'Arbre généalogique — ma branche', treeExample: 'Il manque du monde, et des dates — dites-nous ce que vous savez.' },
...
const IT: Dict = {
  ...
  salvaPage: { title: 'La famiglia', intro: 'Foto, ricordi e storia della famiglia, nel corso degli anni.', historyTitle: 'Storia della famiglia', storyText: [
    ...
    'Suo padre Angelo, tornato dai campi russi, si ritrovò vedovo con un bambino di sei mesi. Lo affidò a sua madre Giuseppina — nonna Pipine —, emigrata a Saint-Étienne con i figli, che lo crebbe come il nono della nidiata.',
  ...
  ], treeTitle: 'Albero genealogico', treeNote: 'Quello che la famiglia ci ha trasmesso. Restano dei vuoti — sono elencati in fondo, e ognuno può colmarli.', treePaternal: 'Nonni paterni', treeMaternal: 'Nonni materni', treeWife1: '1ª moglie', treeWife2: '2ª moglie', treeMarriage1: '1º matrimonio', treeMarriage2: '2º matrimonio', treeGreat: 'Bisnonni', treeParents: 'I genitori', treeQuestionsTitle: 'Quello che ci manca', treeQuestionsNote: 'Queste caselle sono vuote perché nessuno ci ha ancora dato la risposta — non perché non esistano. Siete della famiglia e lo sapete? Ditecelo: è così che l’albero cresce.', treeAdd: '+ Aggiungi il mio ramo', treeAddSubject: 'Albero genealogico — il mio ramo', treeExample: 'Mancano persone e date — diteci quello che sapete.' },
...
const EN: Dict = {
  ...
  salvaPage: { title: 'The family', intro: 'Photos, memories and family history, over the years.', historyTitle: 'Family history', storyText: [
    ...
    'His father Angelo, back from the Russian camps, found himself a widower with a six-month-old baby. He entrusted him to his own mother Giuseppina — granny Pipine — who had emigrated to Saint-Étienne with her children, and who raised him as the ninth of the siblings.',
  ...
  ], treeTitle: 'Family tree', treeNote: 'What the family has passed on to us. Blanks remain — they are listed at the bottom, and anyone can fill them in.', treePaternal: 'Paternal grandparents', treeMaternal: 'Maternal grandparents', treeWife1: '1st wife', treeWife2: '2nd wife', treeMarriage1: '1st marriage', treeMarriage2: '2nd marriage', treeGreat: 'Great-grandparents', treeParents: 'The parents', treeQuestionsTitle: 'What we are missing', treeQuestionsNote: 'These boxes are empty because nobody has given us the answer yet — not because there is none. You are family and you know? Tell us: that is how the tree grows.', treeAdd: '+ Add my branch', treeAddSubject: 'Family tree — my branch', treeExample: 'People and dates are missing — tell us what you know.' },
