...
export type Dict = {
  ...
  stayPage: {
    ...
    legend: { works: string; tentative: string; unknown: string; free: string; fortnight: string };
  };
...
const FR: Dict = {
  ...
  stayPage: { title: 'Le calendrier', intro: 'Les périodes où la maison est occupée, pour se coordonner en famille.', legend: { works: 'En travaux', tentative: 'À confirmer', unknown: 'Tranche à préciser', free: 'Libre', fortnight: 'Quinze jours à caler' } },
  ...
  specialtiesPage: {
    ...
    facts: [
      ...
      },
      {
        icon: 'fork',
        title: 'Les cavati',
        text: 'La pâte de la maison, et elle est d’ici plus que d’ailleurs : semoule de blé dur, eau, sel, rien d’autre — pas un œuf. On roule un boudin, on coupe, et on creuse chaque morceau du bout des doigts, d’où le nom. On les sert avec les ravioli, dans le même plat, sous une sauce de porc et de saucisse de Raguse mijotée des heures avec du strattu. Le détail qui trahit d’où vous venez : à Raguse et dans les monts, la ricotta des ravioli est sucrée ; à Modica et sur la côte — donc chez nous — on la laisse nature, ou relevée au poivre noir et à l’origan.',
      },
      {
        icon: 'citrus',
  ...
  scopaPage: {
    ...
    histoire: [
      ...
      { title: 'Les cartes, elles, sont bien plus vieilles', text: 'La première preuve solide de cartes à jouer en Italie date de [[1376]] : un jeu appelé « naibbe » y est interdit par décret. Trois ans plus tard, une chronique note qu’un jeu nommé « nayb » aurait été introduit par un Sarrasin — [[le mot ne désigne aucun peuple]] : c’est ainsi que l’Europe médiévale appelait les musulmans, faute d’autre terme, « musulman » n’entrant en français qu’en 1551. Les cartes viennent d’Égypte mamelouke, gouvernée de 1250 à 1517 par les [[Mamelouks]] — des soldats pris enfants, élevés en esclaves puis affranchis. Le musée de Topkapi en conserve les paquets, et elles passent en Europe par les péninsules ibérique et italienne. Autrement dit, le jeu qui traîne sur la table est arrivé par [[le même monde arabe>>#arabe]] que le couscous de Trapani.' },
  ...
  quizPage: {
    ...
    italianIntro: 'Des questions tirées de ce cours — prononciation, conjugaison, phrases utiles, mots des chansons. Trois réponses possibles à chaque fois, et chacune vous dit où aller relire.',
    ...
    questions: [
      ...
      { q: 'Avec quoi fait-on les cavati ?', choix: ['Semoule de blé dur, eau et sel', 'Farine, œufs et beurre', 'Semoule et lait'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'Ici, sur la côte, la ricotta des ravioli est…', choix: ['Nature, ou au poivre noir et à l’origan', 'Toujours sucrée', 'Toujours fumée'], bonne: 0, ancre: 'specialites', niveau: 'difficile' },
      ...
      { q: 'Au Moyen Âge, le mot « Sarrasin » désignait…', choix: ['Les musulmans en général — l’Europe n’avait pas d’autre mot', 'Un peuple précis de Syrie', 'Les habitants de la Sardaigne'], bonne: 0, ancre: 'scopa', niveau: 'difficile' },
      { q: 'Qui étaient les Mamelouks ?', choix: ['Des soldats pris enfants, élevés en esclaves puis affranchis', 'Une dynastie de marchands vénitiens', 'Les rois normands de Sicile'], bonne: 0, ancre: 'scopa', niveau: 'difficile' },
      ...
      { q: 'En sicilien, que veut dire « crozza » ?', choix: ['Un crâne', 'Une croix', 'Une croûte'], bonne: 0, ancre: 'italien', niveau: 'moyen' },
      { q: 'D’où vient le texte de « Vitti ’na crozza » ?', choix: ['D’un mineur de soufre de Favara', 'D’un poète de Palerme', 'D’un moine de Modica'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      { q: 'En quelle année Franco Li Causi a-t-il enfin été reconnu auteur de « Vitti ’na crozza » ?', choix: ['1979', '1950', '1962'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      { q: 'Dans « Ciuri ciuri », que sont les ciuri ?', choix: ['Des fleurs', 'Des cerises', 'Des enfants'], bonne: 0, ancre: 'italien', niveau: 'facile' },
      { q: 'Le sicilien fait quoi des -e et des -o finaux de l’italien ?', choix: ['Ils deviennent -i et -u', 'Ils disparaissent', 'Ils doublent'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      ...
      { q: 'À Villa San Giovanni, que fait l’Intercity Notte pour traverser le détroit ?', choix: ['Le train entier monte sur un ferry', 'Les voyageurs descendent et prennent un bateau', 'Il passe par un tunnel'], bonne: 0, ancre: 'voyage', niveau: 'difficile' },
      { q: 'À Messine, le train de nuit…', choix: ['Se coupe en deux : Palerme d’un côté, Syracuse de l’autre', 'S’arrête définitivement', 'Change de locomotive'], bonne: 0, ancre: 'voyage', niveau: 'difficile' },
      { q: 'En bateau, on peut rejoindre Palerme depuis…', choix: ['Gênes, Naples, Livourne, Civitavecchia ou Salerne', 'Uniquement Gênes', 'Uniquement Marseille'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
      { q: 'Sur le bateau vers la Sicile, la cabine…', choix: ['N’est pas obligatoire : il y a des fauteuils inclinables, ou le pont', 'Est le seul moyen de monter à bord', 'Se prend uniquement sur place'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
  ...
  prepare: {
    ...
    actes: [
      ...
      { id: 'maison', title: 'Une fois arrivé' },
    ],
    groups: [
      {
        icon: '✈️',
        ...
        items: [
          'Catania (CTA) — notre aéroport conseillé : le plus de vols, et tout part de là. Comptez [[près de deux heures de route jusqu’à la maison>>#depuis-laeroport]], 130 km.',
          'Comiso (CIY) — le plus proche, environ 40 min de route. Peu de vols, mais quand il y en a un c’est de loin le plus reposant.',
      ...
      },
      {
        ...
        title: 'En voiture',
        links: [
          { label: 'GNV — Gênes, Naples ↔ Palerme', url: 'https://www.gnv.it/fr' },
          { label: 'Grimaldi Lines — Livourne, Civitavecchia, Salerne', url: 'https://www.grimaldi-lines.com/fr/' },
      ...
      },
      {
        ...
        title: 'En train',
        links: [
          { label: 'Trenitalia — horaires et billets', url: 'https://www.trenitalia.com/' },
          { label: 'Intercity Notte — les trains de nuit', url: 'https://www.trenitalia.com/it/intercity-notte.html' },
        ],
        items: [
      ...
      },
      {
        ...
        links: [
          { label: 'Goldcar — louer une voiture', url: 'https://www.goldcar.es/' },
          { label: 'L’itinéraire jusqu’à la maison', url: 'https://www.google.com/maps/dir/?api=1&origin=Aeroporto+di+Catania+Fontanarossa&destination=Via+Basilicata+6%2C+97018+Cava+d%27Aliga+RG&travelmode=driving' },
          { label: 'AST — les bus, horaires', url: 'http://www.aziendasicilianatrasporti.it:8080/' },
          { label: 'AMT Catane — la navette de la gare', url: 'https://www.amt.ct.it/' },
          { label: 'Trenitalia — horaires et billets', url: 'https://www.trenitalia.com/' },
        ...
        items: [
          'Louer une voiture — le cas le plus fréquent, et le plus pratique pour explorer la région : nous conseillons Goldcar. En sortant de l’aérogare, [[prenez à droite]] : tous les loueurs sont regroupés au même endroit.',
          ...
          'Bus AST — vers Modica, Scicli, Donnalucata et Pozzallo. En sortant de l’aérogare, c’est [[à gauche]] : les loueurs de voitures sont à droite, les bus à gauche.',
...
const IT: Dict = {
  ...
  stayPage: { title: 'Il calendario', intro: 'I periodi in cui la casa è occupata, per coordinarsi in famiglia.', legend: { works: 'Lavori in corso', tentative: 'Da confermare', unknown: 'Fascia da precisare', free: 'Libero', fortnight: 'Quindici giorni da fissare' } },
  ...
  specialtiesPage: {
    ...
    facts: [
      ...
      },
      {
        icon: 'fork',
        title: 'I cavati',
        text: 'La pasta di casa, e di qui più che d’altrove: semola di grano duro, acqua, sale, nient’altro — nemmeno un uovo. Si arrotola un filoncino, si taglia, e ogni pezzo si incava con le dita: da lì il nome. Si mangiano insieme ai ravioli, nello stesso piatto, con il sugo di maiale e salsiccia ragusana cotto per ore con lo strattu. Il dettaglio che dice da dove vieni: a Ragusa e nelle zone montane la ricotta dei ravioli è zuccherata; a Modica e sulla costa — quindi da noi — si lascia al naturale, o con pepe nero e origano.',
      },
      {
        icon: 'citrus',
  ...
  scopaPage: {
    ...
    histoire: [
      ...
      { title: 'Le carte, invece, sono molto più antiche', text: 'La prima prova solida di carte da gioco in Italia risale al [[1376]]: un gioco chiamato « naibbe » vi è vietato per decreto. Tre anni dopo una cronaca annota che un gioco detto « nayb » sarebbe stato introdotto da un Saraceno — [[la parola non indica alcun popolo]]: così l’Europa medievale chiamava i musulmani, in mancanza d’altro termine, visto che « musulmano » entra nelle lingue europee solo nel Cinquecento. Le carte vengono dall’Egitto mamelucco, governato dal 1250 al 1517 dai [[mamelucchi]] — soldati presi da bambini, cresciuti schiavi e poi affrancati. Il museo di Topkapi ne conserva i mazzi, e passano in Europa attraverso le penisole iberica e italiana. In altre parole, il gioco che sta sul tavolo è arrivato dallo [[stesso mondo arabo>>#arabe]] del cuscus di Trapani.' },
  ...
  quizPage: {
    ...
    italianIntro: 'Domande tratte da questo corso — pronuncia, coniugazione, frasi utili, parole delle canzoni. Tre risposte possibili ogni volta, e ognuna vi dice dove rileggere.',
    ...
    questions: [
      ...
      { q: 'Con che cosa si fanno i cavati?', choix: ['Semola di grano duro, acqua e sale', 'Farina, uova e burro', 'Semola e latte'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'Qui sulla costa, la ricotta dei ravioli è…', choix: ['Al naturale, o con pepe nero e origano', 'Sempre zuccherata', 'Sempre affumicata'], bonne: 0, ancre: 'specialites', niveau: 'difficile' },
      ...
      { q: 'Nel Medioevo la parola « saraceno » indicava…', choix: ['I musulmani in generale — l’Europa non aveva altra parola', 'Un popolo preciso della Siria', 'Gli abitanti della Sardegna'], bonne: 0, ancre: 'scopa', niveau: 'difficile' },
      { q: 'Chi erano i mamelucchi?', choix: ['Soldati presi da bambini, cresciuti schiavi e poi affrancati', 'Una dinastia di mercanti veneziani', 'I re normanni di Sicilia'], bonne: 0, ancre: 'scopa', niveau: 'difficile' },
      ...
      { q: 'In siciliano, che cosa vuol dire « crozza »?', choix: ['Un teschio', 'Una croce', 'Una crosta'], bonne: 0, ancre: 'italien', niveau: 'moyen' },
      { q: 'Da dove viene il testo di « Vitti ’na crozza »?', choix: ['Da uno zolfataro di Favara', 'Da un poeta di Palermo', 'Da un monaco di Modica'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      { q: 'In che anno Franco Li Causi fu finalmente riconosciuto autore di « Vitti ’na crozza »?', choix: ['1979', '1950', '1962'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      { q: 'In « Ciuri ciuri », che cosa sono i ciuri?', choix: ['I fiori', 'Le ciliegie', 'I bambini'], bonne: 0, ancre: 'italien', niveau: 'facile' },
      { q: 'Che cosa fa il siciliano delle -e e delle -o finali dell’italiano?', choix: ['Diventano -i e -u', 'Spariscono', 'Raddoppiano'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      ...
      { q: 'A Villa San Giovanni, che cosa fa l’Intercity Notte per attraversare lo Stretto?', choix: ['Il treno intero sale su un traghetto', 'I viaggiatori scendono e prendono una nave', 'Passa in un tunnel'], bonne: 0, ancre: 'voyage', niveau: 'difficile' },
      { q: 'A Messina il treno notturno…', choix: ['Si divide in due: Palermo da una parte, Siracusa dall’altra', 'Si ferma definitivamente', 'Cambia locomotiva'], bonne: 0, ancre: 'voyage', niveau: 'difficile' },
      { q: 'In nave si può raggiungere Palermo da…', choix: ['Genova, Napoli, Livorno, Civitavecchia o Salerno', 'Solo Genova', 'Solo Marsiglia'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
      { q: 'Sulla nave per la Sicilia, la cabina…', choix: ['Non è obbligatoria: ci sono poltrone reclinabili, o il ponte', 'È l’unico modo per salire a bordo', 'Si prende solo sul posto'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
  ...
  prepare: {
    ...
    actes: [
      ...
      { id: 'maison', title: 'Una volta arrivati' },
    ],
    groups: [
      {
        icon: '✈️',
        ...
        items: [
          'Catania (CTA) — il nostro aeroporto consigliato: più voli, e da lì parte tutto. Contate [[quasi due ore di strada fino a casa>>#depuis-laeroport]], 130 km.',
          'Comiso (CIY) — il più vicino, circa 40 min di strada. Pochi voli, ma quando ce n’è uno è di gran lunga il più riposante.',
      ...
      },
      {
        ...
        title: 'In auto',
        links: [
          { label: 'GNV — Genova, Napoli ↔ Palermo', url: 'https://www.gnv.it/it' },
          { label: 'Grimaldi Lines — Livorno, Civitavecchia, Salerno', url: 'https://www.grimaldi-lines.com/it/' },
      ...
      },
      {
        ...
        title: 'In treno',
        links: [
          { label: 'Trenitalia — orari e biglietti', url: 'https://www.trenitalia.com/' },
          { label: 'Intercity Notte — i treni notturni', url: 'https://www.trenitalia.com/it/intercity-notte.html' },
        ],
        items: [
      ...
      },
      {
        ...
        links: [
          { label: 'Goldcar — noleggiare un’auto', url: 'https://www.goldcar.es/' },
          { label: 'L’itinerario fino a casa', url: 'https://www.google.com/maps/dir/?api=1&origin=Aeroporto+di+Catania+Fontanarossa&destination=Via+Basilicata+6%2C+97018+Cava+d%27Aliga+RG&travelmode=driving' },
          { label: 'AST — i bus, orari', url: 'http://www.aziendasicilianatrasporti.it:8080/' },
          { label: 'AMT Catania — la navetta della stazione', url: 'https://www.amt.ct.it/' },
          { label: 'Trenitalia — orari e biglietti', url: 'https://www.trenitalia.com/' },
        ...
        items: [
          'Noleggiare un’auto — il caso più frequente, e il più comodo per esplorare la regione: consigliamo Goldcar. Uscendo dall’aerostazione, [[girate a destra]]: tutti gli autonoleggi sono riuniti nello stesso punto.',
          ...
          'Bus AST — verso Modica, Scicli, Donnalucata e Pozzallo. Uscendo dall’aerostazione è [[a sinistra]]: gli autonoleggi a destra, i bus a sinistra.',
...
const EN: Dict = {
  ...
  stayPage: { title: 'The calendar', intro: 'When the house is occupied, so the family can coordinate.', legend: { works: 'Works under way', tentative: 'To confirm', unknown: 'Band to confirm', free: 'Free', fortnight: 'A fortnight, dates to set' } },
  ...
  specialtiesPage: {
    ...
    facts: [
      ...
      },
      {
        icon: 'fork',
        title: 'Cavati',
        text: 'The local pasta, and more from here than anywhere else: durum wheat semolina, water, salt, nothing else — not even an egg. You roll a rope, cut it, and hollow each piece with your fingertips, which is where the name comes from. They are served alongside ravioli, in the same dish, under a pork and Ragusa sausage sauce simmered for hours with strattu. The detail that gives away where you are from: in Ragusa and the hill towns the ricotta in the ravioli is sweetened; in Modica and along the coast — so, here — it is left plain, or seasoned with black pepper and oregano.',
      },
      {
        icon: 'citrus',
  ...
  scopaPage: {
    ...
    histoire: [
      ...
      { title: 'The cards, though, are far older', text: 'The first solid evidence of playing cards in Italy dates from [[1376]]: a game called “naibbe” is banned there by decree. Three years later a chronicle notes that a game named “nayb” was introduced by a Saracen — [[the word names no people at all]]: it is what medieval Europe called Muslims, for want of another term, since “Muslim” only enters the European languages in the 16th century. The cards come from Mamluk Egypt, ruled from 1250 to 1517 by the [[Mamluks]] — soldiers taken as children, raised as slaves and then freed. The Topkapi museum holds the packs, and they reach Europe through the Iberian and Italian peninsulas. In other words, the game lying on the table arrived by [[the same Arab world>>#arabe]] as the couscous of Trapani.' },
  ...
  quizPage: {
    ...
    italianIntro: 'Questions drawn from this course — pronunciation, conjugation, useful phrases, words from the songs. Three possible answers each time, and each one tells you where to go and read it again.',
    ...
    questions: [
      ...
      { q: 'What are cavati made of?', choix: ['Durum wheat semolina, water and salt', 'Flour, eggs and butter', 'Semolina and milk'], bonne: 0, ancre: 'specialites', niveau: 'moyen' },
      { q: 'Here on the coast, the ricotta in the ravioli is…', choix: ['Left plain, or with black pepper and oregano', 'Always sweetened', 'Always smoked'], bonne: 0, ancre: 'specialites', niveau: 'difficile' },
      ...
      { q: 'In the Middle Ages, the word “Saracen” meant…', choix: ['Muslims in general — Europe had no other word', 'One specific people from Syria', 'The inhabitants of Sardinia'], bonne: 0, ancre: 'scopa', niveau: 'difficile' },
      { q: 'Who were the Mamluks?', choix: ['Soldiers taken as children, raised as slaves and then freed', 'A dynasty of Venetian merchants', 'The Norman kings of Sicily'], bonne: 0, ancre: 'scopa', niveau: 'difficile' },
      ...
      { q: 'In Sicilian, what does « crozza » mean?', choix: ['A skull', 'A cross', 'A crust'], bonne: 0, ancre: 'italien', niveau: 'moyen' },
      { q: 'Where do the words of « Vitti ’na crozza » come from?', choix: ['A sulphur miner of Favara', 'A poet from Palermo', 'A monk from Modica'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      { q: 'In what year was Franco Li Causi finally credited as the author of « Vitti ’na crozza »?', choix: ['1979', '1950', '1962'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      { q: 'In « Ciuri ciuri », what are the ciuri?', choix: ['Flowers', 'Cherries', 'Children'], bonne: 0, ancre: 'italien', niveau: 'facile' },
      { q: 'What does Sicilian do to Italian’s final -e and -o?', choix: ['They become -i and -u', 'They disappear', 'They double'], bonne: 0, ancre: 'italien', niveau: 'difficile' },
      ...
      { q: 'At Villa San Giovanni, what does the Intercity Notte do to cross the strait?', choix: ['The whole train is driven onto a ferry', 'Passengers get off and take a boat', 'It goes through a tunnel'], bonne: 0, ancre: 'voyage', niveau: 'difficile' },
      { q: 'At Messina the night train…', choix: ['Splits in two: Palermo one way, Syracuse the other', 'Stops for good', 'Changes locomotive'], bonne: 0, ancre: 'voyage', niveau: 'difficile' },
      { q: 'By boat you can reach Palermo from…', choix: ['Genoa, Naples, Livorno, Civitavecchia or Salerno', 'Genoa only', 'Marseille only'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
      { q: 'On the boat to Sicily, a cabin…', choix: ['Is not compulsory: there are reclining seats, or the deck', 'Is the only way to board', 'Can only be booked on the spot'], bonne: 0, ancre: 'voyage', niveau: 'moyen' },
  ...
  prepare: {
    ...
    actes: [
      ...
      { id: 'maison', title: 'Once you have landed' },
    ],
    groups: [
      {
        icon: '✈️',
        ...
        items: [
          'Catania (CTA) — our recommended airport: the most flights, and everything starts there. Allow [[close to two hours on the road to the house>>#depuis-laeroport]], 130 km.',
          'Comiso (CIY) — the closest, about 40 min away. Few flights, but when there is one it is by far the most restful.',
      ...
      },
      {
        ...
        title: 'By car',
        links: [
          { label: 'GNV — Genoa, Naples ↔ Palermo', url: 'https://www.gnv.it/en' },
          { label: 'Grimaldi Lines — Livorno, Civitavecchia, Salerno', url: 'https://www.grimaldi-lines.com/en/' },
      ...
      },
      {
        ...
        title: 'By train',
        links: [
          { label: 'Trenitalia — timetables and tickets', url: 'https://www.trenitalia.com/' },
          { label: 'Intercity Notte — the night trains', url: 'https://www.trenitalia.com/it/intercity-notte.html' },
        ],
        items: [
      ...
      },
      {
        ...
        links: [
          { label: 'Goldcar — rent a car', url: 'https://www.goldcar.es/' },
          { label: 'The route to the house', url: 'https://www.google.com/maps/dir/?api=1&origin=Aeroporto+di+Catania+Fontanarossa&destination=Via+Basilicata+6%2C+97018+Cava+d%27Aliga+RG&travelmode=driving' },
          { label: 'AST — the buses, timetables', url: 'http://www.aziendasicilianatrasporti.it:8080/' },
          { label: 'AMT Catania — the station shuttle', url: 'https://www.amt.ct.it/' },
          { label: 'Trenitalia — timetables and tickets', url: 'https://www.trenitalia.com/' },
        ...
        items: [
          'Rent a car — the usual case, and the handiest way to explore the region: we recommend Goldcar. As you leave the terminal, [[turn right]]: all the rental desks are grouped in the same spot.',
          ...
          'AST bus — to Modica, Scicli, Donnalucata and Pozzallo. As you leave the terminal it is [[on the left]]: car rentals to the right, buses to the left.',
