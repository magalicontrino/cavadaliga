...
const FR: Dict = {
  ...
  apartment: { eyebrow: 'La maison', title: 'La casa', albumAlt: 'La casa de Cava d’Aliga', captions: ['La terrasse avant', 'La terrasse arrière', 'Le hamac', 'Le séjour', 'La cuisine', 'La grande chambre', 'La petite chambre', 'La chambre-bureau', 'La salle de bain', 'La salle de bain', 'La salle de bain', 'La douche'], rooms: ['La terrasse avant', 'La terrasse arrière', 'Le séjour', 'La cuisine', 'La grande chambre', 'La petite chambre', 'La chambre-bureau', 'La salle de bain'], label: 'La casa' },
  galleryAlt: [
...
const IT: Dict = {
  ...
  apartment: { eyebrow: 'La casa', title: 'La casa', albumAlt: 'La casa di Cava d’Aliga', captions: ['La terrazza davanti', 'La terrazza sul retro', 'L’amaca', 'Il soggiorno', 'La cucina', 'La camera grande', 'La camera piccola', 'La camera-studio', 'Il bagno', 'Il bagno', 'Il bagno', 'La doccia'], rooms: ['La terrazza davanti', 'La terrazza sul retro', 'Il soggiorno', 'La cucina', 'La camera grande', 'La camera piccola', 'La camera-studio', 'Il bagno'], label: 'La casa' },
  galleryAlt: [
...
const EN: Dict = {
  ...
  apartment: { eyebrow: 'The home', title: 'La casa', albumAlt: 'La casa in Cava d’Aliga', captions: ['The front terrace', 'The back terrace', 'The hammock', 'The living room', 'The kitchen', 'The large bedroom', 'The small bedroom', 'The bedroom-study', 'The bathroom', 'The bathroom', 'The bathroom', 'The shower'], rooms: ['The front terrace', 'The back terrace', 'The living room', 'The kitchen', 'The large bedroom', 'The small bedroom', 'The bedroom-study', 'The bathroom'], label: 'La casa' },
  galleryAlt: [
