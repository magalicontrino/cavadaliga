...
export type Dict = {
  ...
  stayPage: {
    ...
    legend: { works: string; tentative: string; unknown: string; free: string };
  };
...
const FR: Dict = {
  ...
  stayPage: { title: 'Le calendrier', intro: 'Les périodes où la maison est occupée, pour se coordonner en famille.', legend: { works: 'En travaux', tentative: 'À confirmer', unknown: 'Tranche à préciser', free: 'Libre' } },
...
const IT: Dict = {
  ...
  stayPage: { title: 'Il calendario', intro: 'I periodi in cui la casa è occupata, per coordinarsi in famiglia.', legend: { works: 'Lavori in corso', tentative: 'Da confermare', unknown: 'Fascia da precisare', free: 'Libero' } },
...
const EN: Dict = {
  ...
  stayPage: { title: 'The calendar', intro: 'When the house is occupied, so the family can coordinate.', legend: { works: 'Works under way', tentative: 'To confirm', unknown: 'Band to confirm', free: 'Free' } },
