...
const FR: Dict = {
  ...
  assistant: {
    ...
    send: 'Chercher',
    suggestions: ['Le code du wifi', 'Poubelles ce soir ?', 'Couper l’eau', 'Une pizza ?', 'Du pain ?', 'Urgences'],
...
const IT: Dict = {
  ...
  assistant: {
    ...
    send: 'Cerca',
    suggestions: ['Password del wifi', 'Rifiuti stasera?', 'Chiudere l’acqua', 'Una pizza?', 'Del pane?', 'Emergenze'],
...
const EN: Dict = {
  ...
  assistant: {
    ...
    send: 'Search',
    suggestions: ['The wifi password', 'Bins tonight?', 'Turn the water off', 'Pizza?', 'Bread?', 'Emergencies'],
