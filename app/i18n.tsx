...
const FR: Dict = {
  ...
  arrivee: {
    ...
    operation: [
      ...
      { icon: 'drop', title: 'Eau', items: ['Pour ouvrir l’eau : la vanne est dans la buanderie, à l’arrière, sur le mur entre le lave-linge et l’évier. Il faut donc la clé de la buanderie — voir juste en dessous.'] },
...
const IT: Dict = {
  ...
  arrivee: {
    ...
    operation: [
      ...
      { icon: 'drop', title: 'Acqua', items: ['Per aprire l’acqua: la valvola è in lavanderia, sul retro, sul muro tra la lavatrice e il lavello. Serve quindi la chiave della lavanderia — vedi qui sotto.'] },
...
const EN: Dict = {
  ...
  arrivee: {
    ...
    operation: [
      ...
      { icon: 'drop', title: 'Water', items: ['To turn the water on: the valve is in the laundry room at the back, on the wall between the washing machine and the sink. So you will need the laundry-room key — see just below.'] },
